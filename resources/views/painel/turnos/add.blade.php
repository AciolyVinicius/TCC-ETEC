    ...
    <div class="container-fluid"> 
        <div class="panel" style="background: #1abc9c; color: white;">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10"><h4>Adicionar Turno</h4></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-style-5">
                            ...
                            <form class="form-horizontal" method="POST" action="/painel/turnos/salvar">                        
                            {{ csrf_field() }}
                                ...
                                <fieldset>
                                    ...
                                    <input id="hr_inicio" type="text" class="form-control" name="hr_inicio" maxlength="5" OnKeyPress="formatar('##:##', this)" value="{{ old('hr_inicio') }}" placeholder="Horario de Inicio *" required autofocus>
                                    ...
                                    <input id="hr_final" type="text" class="form-control" name="hr_final" maxlength="5" OnKeyPress="formatar('##:##', this)" value="{{ old('hr_final') }}" placeholder="Horario de Termino *" required autofocus>
